...
Plans:
- [ ] 02-01: Build brief-interpreter agent (NL brief → structured requirements JSON)
- [ ] 02-02: Build component-selector agent (requirements → PageSpec with approved components only)
- [ ] 02-03: Build page renderer (PageSpec → rendered React page in live preview panel)
